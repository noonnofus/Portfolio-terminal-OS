...
import type { DirectoryNode } from "@/app/desktop/components/directory/directoryTypes";
import { appCatalog } from "@/app/desktop/config/appCatalog";
import { publicAssetPath } from "@/app/desktop/types/appTypes";

const documentIcon = publicAssetPath("/icons/optimized/document.png");

export function DirectoryItemIcon({ node }: { node: DirectoryNode }) {
  const source =
