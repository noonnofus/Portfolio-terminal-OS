...
} from "@/app/gui/lib/pendingNavigation";
import { planNavigation } from "@/app/gui/lib/planNavigation";
import type {
    GuiHistoryState,
    PendingNavigation,
            ...
            switch (plan.historyEffect.type) {
                ...
                case "back": {
                    ...
                    timeoutRef.current = setTimeout(() => {
                        ...
                        setGlobalLanguage(backEffect.fallbackEntry.gui.view.lang);
                        const expiresAt =
                            performance.now() +
                            HISTORY_TRAVERSAL_TIMEOUT_MS;
                        expiredIntentRef.current = {
    ...
    useEffect(() => {
        ...
        const handlePopState = (popStateEvent: PopStateEvent) => {
            ...
            if (
                ...
                setGlobalLanguage(expiredIntent.gui.view.lang);
