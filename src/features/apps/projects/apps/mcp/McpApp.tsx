...
const caseStudySections = [
  {
    id: "problem",
    itemIds: ["apiDiversity", "toolSelection", "longRunning"],
  },
  {
    id: "design",
    itemIds: ["toolContract", "promptBoundary", "executionModel"],
  },
  {
    id: "implementation",
    itemIds: ["apiTools", "meetingMinutes", "streaming", "errorBoundary"],
  },
  {
    id: "outcome",
    itemIds: ["businessExecution", "extensionCost", "executionVisibility"],
  },
] as const;
