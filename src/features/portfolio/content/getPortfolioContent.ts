...
import { projectTitles } from "@/features/portfolio/content/projectTitles";
import type {
    ContactContent,
    EducationContent,
    ExperienceContent,
...
} from "@/features/portfolio/content/types";
import type { Language } from "@/lib/i18n/language";
import {
    isProjectSlug,
    type ProjectSlug,
} from "@/features/portfolio/types/projectTypes";
import enPortfolioContent from "@/features/portfolio/i18n/en/PortfolioContent.json";
import koPortfolioContent from "@/features/portfolio/i18n/ko/PortfolioContent.json";
...
function toPortfolioContent(
    ...
    return {
        ...
        experience: resource.experience.map((experience, index) => ({
            ...experience,
            ...(index === 0
                ? { logo: "/organizations/logosai.svg" }
                : {}),
        })),
